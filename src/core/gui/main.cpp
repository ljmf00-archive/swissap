...
BEGIN_EVENT_TABLE(_23Dialog, wxDialog)
    EVT_CLOSE(_23Dialog::OnClose)
    EVT_BUTTON(idBtnQuit, _23Dialog::OnQuit)
    EVT_BUTTON(idBtnAbout, _23Dialog::OnAbout)
END_EVENT_TABLE()

_23Dialog::_23Dialog(wxDialog *dlg, const wxString &title)
...
void _23Dialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void _23Dialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void _23Dialog::OnAbout(wxCommandEvent &event)
{
