...
int readfile(const char* file_name) { char ch;
FILE *fp;
...
int delfile(const char* file_name) { int status;
...
int copyfile(const char* source_file, const char* target_file) { char ch; FILE *source, *target;
