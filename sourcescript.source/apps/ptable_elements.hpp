...
#ifndef PTABLE_ELEMENTS_HPP_INCLUDED
#define PTABLE_ELEMENTS_HPP_INCLUDED
...
public:
    ...
    void cobalt() {cout << "27		58.9332	Cobalt	Co	1495	2870	8.9		1735	9	[Ar] 3d7 4s2	7.881";}
    void nickel() {cout << "28		58.6934	Nickel	Ni	1453	2732	8.9	0.019	1751	10	[Ar] 3d8 4s2	7.6398";}
    void copper() {cout << "29		63.546	Copper	Cu	1083	2567	8.96		ancient	11	[Ar] 3d10 4s1	7.7264";}
    void zinc() {cout << "30		65.39	Zinc	Zn	420	907	7.13		ancient	12	[Ar] 3d10 4s2	9.3942";}
    void gallium() {cout << "31		69.723	Gallium	Ga	30	2403	5.91		1875	13	[Ar] 3d10 4s2 4p1	5.9993";}
    void germanium() {cout << "32		72.64	Germanium	Ge	937	2830	5.32		1886	14	[Ar] 3d10 4s2 4p2	7.8994";}
    void arsenic() {cout << "33		74.9216	Arsenic	As	81	613	5.72		ancient	15	[Ar] 3d10 4s2 4p3	9.7886";}
    void selenium() {cout << "34		78.96	Selenium	Se	217	685	4.79		1817	16	[Ar] 3d10 4s2 4p4	9.7524";}

    void list_pt()
    {
        cout << "###  NAME        LETTER" << endl << endl;
...
#endif // PTABLE_ELEMENTS_HPP_INCLUDED
